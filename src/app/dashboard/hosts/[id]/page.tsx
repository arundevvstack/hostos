  ...
  return (
    <div className="max-w-[1000px] mx-auto space-y-10 p-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-[32px] font-bold tracking-tight text-foreground font-heading">Edit Host</h2>
          <p className="text-muted-foreground mt-1 text-[16px] font-medium">Update your AI host's personality, knowledge, and voice.</p>
        </div>
      </div>

      <form action={updateHost} className="space-y-10">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div>
              ...
              <div className="space-y-6 bg-card border border-border shadow-sm rounded-[24px] p-7">
                <div className="space-y-3">
                  ...
                  <Input id="name" name="name" defaultValue={host.name} required placeholder="e.g. Sarah, Tech Analyst" className="bg-background border-border text-foreground focus-visible:ring-primary h-[48px] rounded-[14px]" />
                </div>

                <div className="space-y-3">
                  <Label htmlFor="interview_style" className="text-foreground font-semibold">Interview Style</Label>
                  <Select name="interview_style" required defaultValue={host.interview_style || "conversational"}>
                ...
                <div className="space-y-3">
                  ...
                  <Input id="tone_of_voice" name="tone_of_voice" defaultValue={host.tone_of_voice || ''} placeholder="Warm and authoritative" className="bg-background border-border text-foreground h-[48px] rounded-[14px]" />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6 bg-card border border-border shadow-sm rounded-[24px] p-7">
                ...
                <Input type="hidden" name="personality_traits" defaultValue={host.personality_traits?.join(', ')} />
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            <div>
              ...
              <div className="bg-card border border-border shadow-sm rounded-[24px] p-7 space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <Input id="expertise_areas" name="expertise_areas" defaultValue={host.expertise_areas?.join(', ')} placeholder="AI, Startups, Space Tech" className="bg-background border-border text-foreground h-[48px] rounded-[14px]" />
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <Textarea 
                    id="system_prompt" 
                    name="system_prompt" 
                    defaultValue={host.system_prompt || ''}
            ...
            <div>
              ...
              <div className="bg-card border border-border shadow-sm rounded-[24px] p-7">
                <VoiceSettings 
                  initialProvider={host.voice_provider || 'browser'}
                  initialVoiceId={host.voice_id || ''}
